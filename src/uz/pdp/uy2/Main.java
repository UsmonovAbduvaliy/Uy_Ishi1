...
public class Main {
    ...
    private static void loginUser() {
        ...
        while (true) {
            ...
            try(
                    ObjectInputStream ios = new ObjectInputStream(new FileInputStream("C:\\Users\\Abduvaliy\\IdeaProjects\\4M Lesson 8\\src\\uz\\pdp\\uy2\\user_db.txt"))
            ) {
    ...
    private static void registerUser() {
        ...
        try(
                ObjectOutputStream oos  = new ObjectOutputStream(new FileOutputStream("C:\\Users\\Abduvaliy\\IdeaProjects\\4M Lesson 8\\src\\uz\\pdp\\uy2\\user_db.txt"))
        ) {
